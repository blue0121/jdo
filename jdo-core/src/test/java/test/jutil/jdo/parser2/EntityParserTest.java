...
public class EntityParserTest extends ParserTest {
	...
	@ParameterizedTest
	@CsvSource({"test.jutil.jdo.parser2.EntityParserTest$CommonClass,true",
			"test.jutil.jdo.parser2.EntityParserTest$CommonClass2,true",
			"test.jutil.jdo.parser2.EntityParserTest$CommonClass,false",
			"test.jutil.jdo.parser2.EntityParserTest$CommonClass2,false"})
