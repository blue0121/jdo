...
public class InheritedClassTest {
	...
	@ParameterizedTest
	@CsvSource({"test.jutil.jdo.reflect.InheritedClassTest$ChildCommonClass,false",
			"test.jutil.jdo.reflect.InheritedClassTest$ChildCommonClass2,true"})
	...
	@ParameterizedTest
	@CsvSource({"test.jutil.jdo.reflect.InheritedClassTest$ChildCommonClass",
			"test.jutil.jdo.reflect.InheritedClassTest$ChildCommonClass2"})
